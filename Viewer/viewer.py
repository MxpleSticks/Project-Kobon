...
with dpg.window(label="Instructions (usage guide)", modal=True, show=True, tag="popup", width=600, height=400, pos=[100, 100], no_resize=True, no_move=True):
    ...
    with dpg.child_window(height=-40, border=False):
        dpg.add_text(
            ...
            "Project Kobon's viewer allows you to open and inspect arrangment json files\n"
            "genrated by Project Kobon's solver.\n\n"

            "Getting started: \n"
            "1. Click 'Import JSON File' on the right side.\n"
            "2. Select a JSON file that was generated by the solver\n"
            "3. Use Next and Previous buttons to go through the arrangements\n\n"
